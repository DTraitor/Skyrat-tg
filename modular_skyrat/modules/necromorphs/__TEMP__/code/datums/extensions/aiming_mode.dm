...
/datum/component/aim_mode
	dupe_mode = COMPONENT_DUPE_HIGHLANDER
	dupe_type = /datum/component/aim_mode
...
/datum/component/aim_mode/Initialize(obj/item/gun/_gun)
	.=..()
	if(!isliving(parent))
		return COMPONENT_INCOMPATIBLE

	parent.view_range += src.view_range
	parent.view_offset += src.view_offset
	register_statmods(source)
	parent.reset_view()

	if(isgun(_gun))
		gun = _gun
		gun.projectile_damage_multiplier += damage_mod


/datum/component/aim_mode/Destroy()
	parent.view_range -= src.view_range
	parent.view_offset -= src.view_offset
	unregister_statmods(source)
	parent.reset_view()
...
/datum/component/aim_mode/proc/safety()
	//Run periodically
	if (user && gun)
...
/datum/component/aim_mode/basic
...
/datum/component/aim_mode/light
...
/datum/component/aim_mode/heavy
	view_offset = 1*WORLD_ICON_SIZE
	statmods = list(STATMOD_MOVESPEED_ADDITIVE = -0.7,
	STATMOD_RANGED_ACCURACY = 10)

//Long guns are better at this
/datum/component/aim_mode/rifle
...
/datum/component/aim_mode/sniper
